...
//#define TFT_BL 19  // LED back-light (only for ST7789 with backlight control pin)
...
#define TFT_SCLK  SCK
#define TFT_CS    SPI_CS0  // Chip select control pin
#define TFT_DC    4  // Data Command control pin
//#define TFT_RST   4  // Reset pin (could connect to RST pin)
#define TFT_RST  GPIO_NUM_22  // Set TFT_RST to -1 if display RESET is connected to ESP32 board RST
